...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSettingENDCLASS_t qt_meta_stringdata_CLASSSettingENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 15),  // "signalSetAction"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 21),  // "std::function<void()>"
        QT_MOC_LITERAL(47, 6),  // "action"
        QT_MOC_LITERAL(54, 18)   // "on_pb_save_clicked"
    },
    "Setting",
    "signalSetAction",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSettingENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       5,    0,   33,    2, 0x08,    5 /* Private */,

 // signals: parameters
    QMetaType::Void, QMetaType::Int, QMetaType::QString, 0x80000000 | 3,    2,    2,    4,
...
void Setting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signalSetAction((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<std::function<void()>>>(_a[3]))); break;
        ...
        {
            using _t = void (Setting::*)(int , QString , std::function<void()> );
            if (_t _q_method = &Setting::signalSetAction; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Setting::signalSetAction(int _t1, QString _t2, std::function<void()> _t3)
{
